...
tmux send-keys "DISPLAY=:0 roslaunch hri16_experiment hrsi_robot_play.launch"

tmux select-window -t $SESSION:8
tmux send-keys "DISPLAY=:0 rosrun hri16_experiment hri16_robot_play.py _out_dir:=/localhome/strands/cdondrup"
